...
//   }
//
//   void customBottomSheet({context, VoidCallback getValue, List<Member> data}) {
...
//                                         childValueCount = data[index].member - 2;
//                                         roleId = data[index].id.toString();
//                                         if(data[index].plans.quarterly != null && data[index].plans.quarterly.feeType != null){
//                                           if( widget.response[widget.plan_index]['fee_type'] == data[index].plans.quarterly.feeType){
//                                             setState((){
...
//                                             });
//                                           }
//                                         }else if(data[index].plans.halfYearly != null && data[index].plans.halfYearly.feeType != null){
//                                           if( widget.response[widget.plan_index]['fee_type'] == data[index].plans.halfYearly.feeType){
//                                             setState((){
...
//                                             });
//                                           }
//                                         }else if(data[index].plans.yearly != null && data[index].plans.yearly.feeType != null){
//                                           if( widget.response[widget.plan_index]['fee_type'] == data[index].plans.yearly.feeType){
//                                             setState((){
...
//                                           print("Null values");
//                                         }
//                                         // rolePlanId = widget.response[widget.plan_index]['fee_type'] == data[index].plans.monthly.feeType
//                                         //     ? data[index]
//                                         //         .plans
//                                         //         .monthly
//                                         //         .id
...
//                                         //                 : "Something Wrong";
//                                         //
//                                         // rolePlanFee = widget.response[widget.plan_index]['fee_type'] == data[index].plans.monthly.feeType ? data[index].plans.monthly.fee.toString() : widget.response[widget.plan_index]['fee_type'] == data[index].plans.quarterly.feeType ? data[index].plans.quarterly.fee.toString() : widget.response[widget.plan_index]['fee_type'] == data[index]
//                                         //                     .plans
//                                         //                     .halfYearly
//                                         //                     .feeType
//                                         //             ? data[index]
...
//                               showProgress(context, "Please wait.....");
//                               errorMessage1 = '';
//                               signUpToServer(parms: parms).then((response) {
//                                 dismissDialog(context);
//                                 if (response.status) {
